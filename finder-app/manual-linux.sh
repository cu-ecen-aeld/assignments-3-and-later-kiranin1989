...
sudo cp -p ${SYSROOT}/lib/ld-linux-aarch64.so.1 lib/ld-linux-aarch64.so.1
sudo cp -p ${SYSROOT}/lib64/libm.so.6 lib64/libm.so.6
sudo cp -p ${SYSROOT}/lib64/libresolv.so.2 lib64/libresolv.so.2
sudo cp -p ${SYSROOT}/lib64/libc.so.6 lib64/libc.so.6
